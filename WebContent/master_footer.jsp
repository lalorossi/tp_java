...
<!-- FOOTER -->
	...
	<footer class="page-footer font-small pt-4" style="background-color: #f8f9fa; color: darkcyan">
		...
		<!-- /Contenedor enlaces -->
		<div class="row my-3 px-16 text-center">
			<div class="col-md-12">
				<a href="#" class="mx-5" style="text-decoration: none">
	...
	<div class="toast mr-3 mt-3" id="toast-warning" style="position: relative">
		<div class="toast-warning-header bg-warning">
			<strong class="mr-auto">
				<i class="fas fa-exclamation-circle ml-1"></i> Tarjetas permitidas
			</strong>
